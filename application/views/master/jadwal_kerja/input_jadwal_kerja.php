  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Input Jadwal Kerja</h1>
          </div><!-- /.col -->
          <!-- Lokasi Halaman -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <form action="<?php echo base_url('jadwal_kerja/input/save')?>" method="post">
                    <div class="card-body">
                      ...
                      <?php unset($_SESSION['msg']); endif; ?>
                        <div class="form-group">
                            ...
                            <select class="custom-select rounded-0" name="id_karyawan" required>
                            <?php
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Ikutkan Hari Minggu?</label>
                            <select class="custom-select rounded-0" id="hari_minggu" name="hari_minggu" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select rounded-0" name="id_jam_kerja" onchange="myFunction(this.value)" required>
                            <?php
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="time" class="form-control" id="jam_masuk" name="jam_masuk" placeholder="Jam Masuk" value="07:00" readonly>
                                </div>
                                <div class="col-6">
                                    <label for="exampleInputEmail1">Jam Pulang</label>
                                    <input type="time" class="form-control" id="jam_pulang" name="jam_pulang" placeholder="Jam Pulang" value="15:00" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="time" class="form-control" id="jam_masuk_sabtu" name="jam_masuk_sabtu" value="07:00" placeholder="Jam Masuk" readonly>
                                </div>
                                <div class="col-6">
                                    <label for="exampleInputEmail1">Jam Pulang Sabtu</label>
                                    <input type="time" class="form-control" id="jam_pulang_sabtu" name="jam_pulang_sabtu" value="12:00" placeholder="Jam Pulang" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
  ...
  function checkMinggu() {
    // var checkedValue = document.querySelector('.custom-control-input:checked').value;
    var checkedValue = $('.form-check-input:checked').val();
    //var checkedValue = document.getElementById('hari_minggu');
    if(checkedValue == true){
      document.getElementById('hasil_check').value = "true";
    }else{
      document.getElementById('hasil_check').value = "false";
    }
    console.log(checkedValue);
    // var checkedValue = null; 
    // var inputElements = document.getElementsByClassName('hari_minggu');
