  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">History Surat Ijin</h1>
          </div><!-- /.col -->
          <!-- Lokasi Halaman -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/payroll/main">Home</a></li>
              <li class="breadcrumb-item active">History Surat Ijin</li>
            </ol>
          </div><!-- /.col -->
          <!-- /. Lokasi Halaman -->
        </div><!-- /.row -->
                  ...
                  <?php 
                      ...
                      foreach ($fetch as $row) {
                        echo "<tr>";
                          ...
                          echo "<td>".$row['pilih_jam']."</td>";
                          echo "<td>".$row['jam_datang_keluar_ijin']."</td>";
                          if($row['persetujuan_kabag']=='Y'){
