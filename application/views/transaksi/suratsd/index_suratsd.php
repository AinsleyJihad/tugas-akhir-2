  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Surat Sakit / Dinas</h1>
          </div><!-- /.col -->
          <!-- Lokasi Halaman -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/payroll/main">Home</a></li>
              <li class="breadcrumb-item active">Surat Sakit_Dinas</li>
            </ol>
          </div><!-- /.col -->
          <!-- /. Lokasi Halaman -->
        </div><!-- /.row -->
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Hapus Surat Sakit Dinas</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form action="<?php echo base_url('suratsd/hapus')?>" method="post">
            <div class="modal-body">
                <div class="card-body">
                  <p>Apakah anda yakin ingin menghapus surat ini?</p>
                    <input type="text" class="form-control" id="id_surat" name="id_surat" hidden>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-2">
                    <a href="/payroll/suratsd/input"><button type="button" class="btn btn-block btn-success"><i class="fas fa-plus"></i>Input Surat SD</button></a>
                  </div>
                </div>
                  ...
                  <?php 
                      ...
                      foreach ($fetch as $row) {
                        echo "<tr>";
                          ...
                          echo "<td>".$row['keterangan_surat']."</td>";
                          if($row['status_surat']=='Y'){
                          ...
                          echo '<td>
                                    <a href="/payroll/suratsd/edit/'.$row['id_surat'].'"><button type="button" class="btn btn-block btn-info"><i class="fas fa-edit"></i></button></a>
...
<script>
  $('#exampleModal').on('show.bs.modal', function (event) {
    ...
    var modal = $(this)
    modal.find('.modal-title').text('Hapus Surat SD')
    modal.find('#id_surat').val(id_surat)
