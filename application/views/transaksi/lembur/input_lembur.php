          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form action="<?php echo base_url('lembur/input/save')?>" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_lembur" name="tanggal_lembur" placeholder="Tanggal Mulai" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="time" id="jam_mulai" name="jam_mulai" class="form-control" placeholder="Tanggal Mulai" required>
                                </div>
                                <div class="col-6">
                                    <label for="exampleInputEmail1">Jam Akhir*</label>
                                    <input type="time" id="jam_akhir" name="jam_akhir" class="form-control" placeholder="Tanggal Mulai" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Uraian Kerja*</label>
                            <input type="text" class="form-control" id="uraian_kerja" name="uraian_kerja" placeholder="Masukkan Uraian Kerja" min="0" required>
                            </input>
                        </div>
                    </div>
                    <!-- /.card-body -->
