    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url('cuti/edit/save/'.$cuti[0]['id_cuti'])?>" method="post">
            <div class="modal-body">
                <div class="card-body">
                  <p id="judul_modal_2">Apakah anda yakin ingin edit cuti?</p>
                  <p id="m_sisa_cuti_baru">Sisa cuti baru: ""</p>
                    ...
                    <div class="form-group">
                      <div class="row">
                          <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="m_id_cuti" name="m_id_cuti" placeholder="ID Cuti" value="<?php echo $cuti[0]['view_id']; ?>" readonly>
                          </div>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" hidden>
                      ...
                      <input type="text" class="form-control" name="m_status_cuti" id="m_status_cuti" readonly>
                      </input>
                    </div>
                    <div class="form-group" hidden>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" id="m_submit" class="btn btn-success">Edit</button>
            </div>
          </form>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php unset($_SESSION['msg']); endif; ?>
                    <div class="card-body">
                    <?php //echo $cuti[0]['ambil_tahun_sekarang'].", ".$cuti[0]['ambil_cuti']; ?>
                        <div class="form-group">
                            <label for="exampleInputEmail1">ID Cuti</label>
                            <input type="text" class="form-control" id="id_cuti" name="id_cuti" placeholder="ID Cuti" value="<?php echo $cuti[0]['view_id']; ?>" disabled>
                        </div>
                        <div class="form-group" hidden>
                            <label for="exampleInputEmail1">id_k</label>
                            <input type="text" class="form-control" name = "id_karyawan" id="id_karyawan" placeholder="" value="<?php echo $cuti[0]['id_karyawan']; ?>" >
                            </input>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Karyawan</label>
                              ...
                              foreach($karyawan as $k){ 
                                if($cuti[0]['id_karyawan'] == $k['id_karyawan'])
                                  echo"<input type='text' class='form-control' name='id_karyawa' id='id_karyawa' placeholder='Masukkan Tahun Cuti' value='".$k['nama_karyawan']. " - ".$k['idk']."' readonly>";
                              } ?>
                        ...
                        <!-- <div class="form-group">
                            <label for="exampleInputEmail1">Nama Karyawan</label>
                            <select class="custom-select rounded-0" name="id_karyawa" id="id_karyawa" onchange="ambilsisa()" value="<?php echo $cuti[0]['id_karyawan']; ?>" readonly="readonly">
                            <?php
                                foreach($karyawan as $k){ 
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tahun Cuti*</label>
                            <input type="Number" class="form-control" name = "tahun_cuti" id="tahun_cuti" placeholder="Masukkan Tahun Cuti" value="<?php echo $cuti[0]['tahun_cuti']; ?>" onchange="ambilsisa()" readonly>
                            </input>
                        </div>
                        <div class="form-group">
                          <div class="row">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    <label for="exampleInputEmail1">Tanggal Mulai Cuti*</label>
                                    <input type="date" class="form-control" name="tanggal_mulai" id="tanggal_mulai" placeholder="Tanggal Mulai" value="<?php echo $cuti[0]['tanggal_mulai_cuti']; ?>" onchange="ambiltotal()" required>
                                </div>
                                <div class="col-6">
                                    <label for="exampleInputEmail1">Tanggal Akhir Cuti*</label>
                                    <input type="date" class="form-control" name = "tanggal_akhir" id="tanggal_akhir" placeholder="Tanggal Akhir" value="<?php echo $cuti[0]['tanggal_akhir_cuti']; ?>" onchange="ambiltotal()" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Alasan Cuti* </label>
                            <input type="text" class="form-control" name="alasan_cuti" id="alasan_cuti" placeholder="Masukkan Alasan Cuti" value="<?php echo $cuti[0]['alasan_cuti']; ?>" onchange="check()"  required>
                            </input>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Status*</label>
                            <select class="custom-select rounded-0" id="status_cuti" name="status_cuti" required>
                    ...
                    <div class="card-footer">
                      ...
                      ><button type="submit" id="submit" class="btn btn-primary">Submit</button></a>
                    </div>
              </div>
              <!-- /.card-body -->
            </div>
...
$(document).ready(function () {
    ...
    foreach($karyawan as $j){ ?>
        if(<?php echo $j['id_karyawan']; ?> == <?php echo $cuti[0]['id_karyawan']; ?>)
        {
    ...
    */
    //sisa cuti
    var url = "http://localhost/payroll/cuti/ambilSisaCuti";
    ...
    $.ajax(
      {
        ...
        console.log(data);
        //console.log((parseInt(data[0].sisa_cuti_tahun_kemarin,10) + parseInt(<?php echo $cuti[0]['ambil_cuti'] ?>,10)).toString());
        ...
        if(<?php echo "'".$cuti[0]['ambil_tahun_sekarang']."'"; ?> == "N")
        {
            document.getElementById('sisa_cuti_tahun_kemarin').value = (parseInt(data[0].sisa_cuti_tahun_kemarin, 10) + parseInt(<?php echo $cuti[0]['ambil_cuti'] ?>, 10)).toString() ;
            document.getElementById('sisa_cuti_tahun_ini').value = data[0].sisa_cuti_tahun_ini;
        }
        else if(<?php echo "'".$cuti[0]['ambil_tahun_sekarang']."'"; ?> == "Y")
        {
            document.getElementById('sisa_cuti_tahun_kemarin').value = data[0].sisa_cuti_tahun_kemarin;
            document.getElementById('sisa_cuti_tahun_ini').value = (parseInt(data[0].sisa_cuti_tahun_ini,10) + parseInt(<?php echo $cuti[0]['ambil_cuti'] ?>, 10)).toString();
        }
    ...
    //status
    var status = "<?php echo $cuti[0]['status_cuti'] ?>";
    if(status == "Y")
    {
        document.getElementById("status_cuti").selectedIndex = 0;
        //selectElement('status_divisi', 'Y');
    }
    else
    {
        document.getElementById("status_cuti").selectedIndex = 1;
  ...
  $('#exampleModal').on('show.bs.modal', function (event) {
    ...
    var status_cuti = document.getElementById("status_cuti").value;
    ...
    console.log("status_cuti : "+status_cuti);
    ...
    document.getElementById('m_status_cuti').value = status_cuti;
    ...
    if(bulan <= 5)
    {
      if(parseInt(sisa_cuti_tahun_kemarin) - parseInt(total_ambil) >= 0)
      {
        ...
        document.getElementById("judul_modal_2").innerHTML = "Apakah anda yakin ingin edit cuti?";
    ...
    var modal = $(this)
    modal.find('.modal-title').text('Edit Cuti')
  ...
  )
  {
    if(total_ambil != "Tanggal akhir tidak boleh kurang dari tanggal mulai")
    {
      if(tahun_cuti > 999 && tahun_cuti < 10000)
      {
        if(<?php echo "'".$cuti[0]['ambil_tahun_sekarang']."'"; ?> == "N")
        {
          //console.log(parseInt(sisa_cuti_tahun_kemarin,10) - parseInt(total_ambil,10));
            if(parseInt(sisa_cuti_tahun_kemarin,10) - parseInt(total_ambil,10) < 0)
        ...
        {
          //console.log(parseInt(sisa_cuti_tahun_ini,10) - parseInt(total_ambil,10));
          if(parseInt(sisa_cuti_tahun_ini,10) - parseInt(total_ambil,10) < 0)
            document.getElementById("submit").disabled = true;
          else
            document.getElementById("submit").disabled = false;
