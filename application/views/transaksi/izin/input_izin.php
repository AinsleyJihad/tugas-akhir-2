          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form action="<?php echo base_url('izin/input/save')?>" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_ijin" name="tanggal_ijin" placeholder="Tanggal Mulai" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Alasan Izin*</label>
                            <input type="text" class="form-control" id="alasan_ijin" name="alasan_ijin" placeholder="Masukkan Alasan Izin" min="0" required>
                            </input>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="jam_datang_keluar_ijin" name="jam_datang_keluar_ijin" placeholder="Masukkan Jam Datang Keluar Izin" required>
                            </input>
                        </div>
                    </div>
                    <!-- /.card-body -->
