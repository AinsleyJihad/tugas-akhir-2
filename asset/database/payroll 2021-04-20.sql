...
--
-- Host: localhost
-- Generation Time: Mar 24, 2021 at 05:00 AM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `getAlasanIzin` (`id` VARCHAR(15), `tgl` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `getIdSuratIzin` (`id` VARCHAR(15), `tgl` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
	...
	SELECT (IF(EXISTS(
        ...
        WHERE transaksi_surat_ijin.id_karyawan = a.id_karyawan AND transaksi_surat_ijin.tanggal_ijin = a.tanggal_jadwal AND transaksi_surat_ijin.status_ijin = 'Y'
               ...
               (SELECT transaksi_surat_ijin.id_surat_ijin
                FROM transaksi_surat_ijin
                WHERE transaksi_surat_ijin.id_karyawan = a.id_karyawan AND transaksi_surat_ijin.tanggal_ijin = @tanggal AND transaksi_surat_ijin.status_ijin = 'Y'), 'N')) into id_surjin
    FROM master_jd_kerja_kyw as a,
         master_karyawan as b,
         master_jam_kerja c,
         master_divisi d
...
CREATE DEFINER=`root`@`localhost` FUNCTION `getJamIzin` (`id` VARCHAR(15), `tgl` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `getJamMasuk` (`id` VARCHAR(15), `tgl` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
  	DECLARE jam VARCHAR(20) DEFAULT '';
...
CREATE DEFINER=`root`@`localhost` FUNCTION `getJamPulang` (`id` VARCHAR(15), `tgl` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
  	DECLARE jam VARCHAR(20) DEFAULT '';
	...
	SELECT COUNT(a.id_karyawan) as potong_absen into potong
                    ...
                    WHERE a.status = 'Y' AND
                        ...
                        IF(DAYNAME(a.tanggal_jadwal) = 'Saturday',
                           IF(getStatusCuti(a.id_karyawan, a.tanggal_jadwal) = 'N',
                              IF(getJamMasuk(a.id_karyawan, a.tanggal_jadwal) <> getJamPulang(a.id_karyawan, a.tanggal_jadwal),
                                 IF(getIdSuratIzin(a.id_karyawan, a.tanggal_jadwal) = 'N',
                                    IF(TIMEDIFF (getJamMasuk(a.id_karyawan, a.tanggal_jadwal), c.jam_masuk_sabtu) >= '0:10:0', 2=1, 
                                       IF(TIMEDIFF (getJamPulang(a.id_karyawan, a.tanggal_jadwal), c.jam_pulang_sabtu) >= '0:0:0', 2=1, 2=1)),
                                    2=1), 1=1), 2=1),
                           IF(getStatusCuti(a.id_karyawan, a.tanggal_jadwal) = 'N',
                              IF(getJamMasuk(a.id_karyawan, a.tanggal_jadwal) <> getJamPulang(a.id_karyawan, a.tanggal_jadwal),
                                 IF(getIdSuratIzin(a.id_karyawan, a.tanggal_jadwal) = 'N',
                                    IF(TIMEDIFF (getJamMasuk(a.id_karyawan,a.tanggal_jadwal), c.jam_masuk) >= '0:10:0', 2=1,
                                       IF(TIMEDIFF (getJamPulang(a.id_karyawan, a.tanggal_jadwal), c.jam_pulang) >= '0:0:0', 2=1, 2=1)),
                                    2=1), 1=1), 2=1)
                          );
  	RETURN potong;
END$$
...
CREATE DEFINER=`root`@`localhost` FUNCTION `getStatusCuti` (`id` VARCHAR(15), `tgl` VARCHAR(20)) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
...
(2, '4649', 2021, 11, 9, 2, '2021-02-22', '2021-02-23', 'Alasan Cuti 222', 'Y', 'N', 'Form / HRD / 017-Rev.00', 'Y', 'Edit', 1, '2021-03-23'),
(10, '2072', 2021, 11, 0, 11, '2021-03-23', '2021-04-02', '111', 'Y', 'N', 'Form / HRD / 017-Rev.00', 'Y', 'Create', 1, '2021-03-23'),
(11, '2072', 2021, 11, 0, 11, '2021-04-03', '2021-04-13', '111', 'Y', 'Y', 'Form / HRD / 017-Rev.00', 'Y', 'Create', 1, '2021-03-23'),
(12, '2072', 2021, 0, 0, 0, '2021-03-23', '2021-03-23', 'alasan cuti', 'Y', 'N', 'Form / HRD / 017-Rev.00', 'Y', 'Create', 1, '2021-03-23'),
(13, '2072', 2021, 0, 0, 0, '2021-03-23', '2021-03-23', 'alasan cuti', 'Y', 'Y', 'Form / HRD / 017-Rev.00', 'Y', 'Create', 1, '2021-03-23');
...
('2072', '2072', 2, 10, 'AFIF NUZIA AL ASADI', '1234567891234560', '1234567891234560', '', 'L', '2020-08-03', '0000-00-00', 'Y', '', '', '0000-00-00', '', '0000-00-00', 'Karyawan', 'Tidak Kontrak', '', '', '', 5000000, 'Edit', 1, '2021-03-24');
...
(9, '2003', 2021, 1, 2000, NULL, NULL, 'Input Tunjangan Kelu', 'Y', 1, '2021-03-23'),
(5, '2004', 2021, 1, 0, NULL, NULL, 'Input Tunjangan Kelu', 'Y', 1, '2021-03-23'),
(10, '2007', 2021, 1, NULL, 0, NULL, 'Input Ongkos Bongkar', 'Y', 1, '2021-03-23'),
(11, '2034', 2021, 1, NULL, NULL, 100000, 'Input Ongkos Lain', 'Y', 1, '2021-03-23'),
(8, '2006', 2021, 1, 250000, NULL, NULL, 'Input Tunjangan Kelu', 'Y', 1, '2021-03-23'),
(12, '2011', 2021, 1, NULL, NULL, 0, 'Input Ongkos Lain', 'Y', 1, '2021-03-23'),
(13, '2007', 2021, 1, NULL, NULL, 11234, 'Input Ongkos Lain', 'Y', 1, '2021-03-23'),
(4, '2001', 2021, 1, NULL, NULL, 0, 'Input Ongkos Lain', 'Y', 1, '2021-03-23'),
(13, '2072', 2021, 3, 0, NULL, NULL, 'Input Tunjangan Kelu', 'Y', 1, '2021-03-23');
...
(4, '2072', 2021, 3, 328125, 'utang perusahaan', 'Y', 'Create', 1, '2021-03-23'),
(5, '2072', 2021, 2, 328125, 'utang perusahaan', 'Y', 'Create', 1, '2021-03-24');
...
(2, '2031', '2021-01-03', 'Alasan Izin...', 'Jam Datang', '12:30:00', 'Form/HRD/018-Rev.01', 'Y', 'Edit', 1, '2021-03-23'),
(14, '2017', '2021-01-04', 'alasan datang', 'Jam Datang', '10:40:00', 'Form/HRD/018-Rev.01', 'Y', 'Edit', 1, '2021-03-23');
...
(8, 2021, 8000000, 15341, 'Y', 'Edit', 1, '2021-03-24'),
(8, 2021, 4293582, 15341, 'Y', 'Edit', 1, '2021-03-24'),
(2, 2020, 4199000, 1000, 'Y', 'Edit', 1, '2021-03-24');
...
('2021022500000002', '2072', '2021-02-25', '07:30:00', 'Edit', 'Y', 1, '2021-03-23'),
('2021022500000003', '2072', '2021-02-25', '17:30:00', 'Edit', 'Y', 1, '2021-03-23'),
('2021022600000001', '4649', '2021-02-26', '22:21:00', 'Edit', 'Y', 2, '2021-02-24'),
('2021022600000002', '2072', '2021-02-26', '07:30:00', 'Edit', 'Y', 1, '2021-03-23'),
('2021022600000003', '2072', '2021-02-26', '16:30:00', 'Edit', 'Y', 1, '2021-03-23'),
...
(24, '2072', 4, '2021-01-04', 'N', '2021-03-18', 1),
...
(69, '2072', 4, '2021-01-05', 'N', '2021-03-18', 1),
...
(127, '2072', 4, '2021-01-06', 'N', '2021-03-18', 1),
...
(180, '2072', 4, '2021-01-07', 'N', '2021-03-18', 1),
...
(209, '2072', 4, '2021-01-08', 'N', '2021-03-18', 1),
...
(277, '2072', 4, '2021-01-09', 'N', '2021-03-18', 1),
...
(320, '2072', 4, '2021-01-11', 'N', '2021-03-18', 1),
...
(370, '2072', 4, '2021-01-12', 'N', '2021-03-18', 1),
...
(418, '2072', 4, '2021-01-13', 'N', '2021-03-18', 1),
...
(471, '2072', 4, '2021-01-14', 'N', '2021-03-18', 1),
...
(518, '2072', 4, '2021-01-15', 'N', '2021-03-18', 1),
...
(567, '2072', 4, '2021-01-16', 'N', '2021-03-22', 1),
...
(614, '2072', 4, '2021-01-18', 'N', '2021-03-18', 1),
...
(649, '2072', 4, '2021-01-19', 'N', '2021-03-18', 1),
...
(713, '2072', 4, '2021-01-20', 'N', '2021-03-18', 1),
...
(748, '2072', 4, '2021-01-21', 'N', '2021-03-18', 1),
...
(791, '2072', 4, '2021-01-22', 'N', '2021-03-18', 1),
...
(855, '2072', 4, '2021-01-23', 'N', '2021-03-18', 1),
...
(898, '2072', 4, '2021-01-25', 'N', '2021-03-18', 1),
...
(949, '2072', 4, '2021-01-26', 'N', '2021-03-18', 1),
...
(997, '2072', 4, '2021-01-27', 'N', '2021-03-18', 1),
...
(1045, '2072', 4, '2021-01-28', 'N', '2021-03-18', 1),
...
(1091, '2072', 4, '2021-01-29', 'N', '2021-03-18', 1),
...
(1131, '2072', 4, '2021-01-30', 'N', '2021-03-18', 1),
...
(1196, '2072', 4, '2021-02-01', 'N', '2021-03-18', 1),
...
(1217, '4649', 1, '2021-03-24', 'N', '2021-03-02', 1),
(1218, '4649', 1, '2021-02-23', 'N', '2021-03-02', 1),
(1220, '2029', 1, '2021-03-03', 'N', '2021-03-02', 1),
(1221, '2029', 2, '2021-03-04', 'N', '2021-03-02', 1),
(1222, '2031', 1, '2021-03-02', 'N', '2021-03-02', 1),
(1223, '4648', 7, '2021-03-02', 'N', '2021-03-02', 1),
(1224, '4654', 1, '2021-03-03', 'Y', '2021-03-03', 1),
(1225, '2072', 4, '2021-01-01', 'N', '2021-03-18', 1),
(1226, '2072', 4, '2021-01-02', 'N', '2021-03-18', 1),
(1227, '2072', 4, '2021-01-04', 'Y', '2021-03-05', 1),
(1228, '2072', 4, '2021-01-05', 'Y', '2021-03-05', 1),
(1229, '2072', 4, '2021-01-06', 'Y', '2021-03-05', 1),
(1230, '2072', 4, '2021-01-07', 'Y', '2021-03-05', 1),
(1231, '2072', 4, '2021-01-08', 'Y', '2021-03-05', 1),
(1232, '2072', 4, '2021-01-09', 'Y', '2021-03-05', 1),
(1233, '2072', 4, '2021-01-11', 'Y', '2021-03-05', 1),
(1234, '2072', 4, '2021-01-12', 'Y', '2021-03-05', 1),
(1235, '2072', 4, '2021-01-13', 'Y', '2021-03-05', 1),
(1236, '2072', 4, '2021-01-14', 'Y', '2021-03-05', 1),
(1237, '2072', 4, '2021-01-15', 'Y', '2021-03-05', 1),
(1238, '2072', 4, '2021-01-16', 'Y', '2021-03-05', 1),
(1239, '2072', 4, '2021-01-18', 'Y', '2021-03-05', 1),
(1240, '2072', 4, '2021-01-19', 'Y', '2021-03-05', 1),
(1241, '2072', 4, '2021-01-20', 'Y', '2021-03-05', 1),
(1242, '2072', 4, '2021-01-21', 'Y', '2021-03-05', 1),
(1243, '2072', 4, '2021-01-22', 'Y', '2021-03-05', 1),
(1244, '2072', 4, '2021-01-23', 'Y', '2021-03-05', 1),
(1245, '2072', 4, '2021-01-25', 'Y', '2021-03-05', 1),
(1246, '2072', 4, '2021-01-26', 'Y', '2021-03-05', 1),
(1247, '2072', 4, '2021-01-27', 'Y', '2021-03-05', 1),
(1248, '2072', 4, '2021-01-28', 'Y', '2021-03-05', 1),
(1249, '2072', 4, '2021-01-29', 'Y', '2021-03-05', 1),
(1250, '2072', 4, '2021-01-30', 'Y', '2021-03-05', 1),
(1251, '2072', 4, '2021-02-01', 'Y', '2021-03-05', 1),
(1252, '2072', 4, '2021-02-02', 'Y', '2021-03-05', 1),
(1253, '2072', 4, '2021-02-03', 'Y', '2021-03-05', 1),
(1254, '2072', 4, '2021-02-04', 'N', '2021-03-18', 1),
(1255, '2072', 4, '2021-02-05', 'Y', '2021-03-05', 1),
(1256, '2072', 4, '2021-02-06', 'Y', '2021-03-05', 1),
(1257, '2072', 4, '2021-02-08', 'Y', '2021-03-05', 1),
(1258, '2072', 4, '2021-02-09', 'Y', '2021-03-05', 1),
(1259, '2072', 4, '2021-02-10', 'Y', '2021-03-05', 1),
(1260, '2072', 4, '2021-02-11', 'Y', '2021-03-05', 1),
(1261, '2072', 4, '2021-02-12', 'Y', '2021-03-05', 1),
(1262, '2072', 4, '2021-02-13', 'Y', '2021-03-05', 1),
(1263, '2072', 4, '2021-02-15', 'Y', '2021-03-05', 1),
(1264, '2072', 4, '2021-02-16', 'Y', '2021-03-05', 1),
(1265, '2072', 4, '2021-02-17', 'Y', '2021-03-05', 1);
...
(2072, '2072', '2072', 2, 10, 'AFIF NUZIA AL ASADI', '1234567891234560', '1234567891234560', '', 'L', '2020-08-03', '0000-00-00', 'Y', '', '', '0000-00-00', '', '0000-00-00', 'Karyawan', 'Tidak Kontrak', '', '', '', 5000000, 1, '2021-03-24'),
...
(2, 2020, 4199000, 1000, 'Y', 1, '2021-03-24'),
...
(8, 2021, 4293582, 15341, 'Y', 1, '2021-03-24');
...
(2, '4649', 2021, 11, 9, 2, '2021-02-22', '2021-02-23', 'Alasan Cuti 222', 'Y', 'N', 'Form / HRD / 017-Rev.00', 'Y', 1, '2021-03-23'),
...
(10, '2072', 2021, 11, 0, 11, '2021-03-23', '2021-04-02', '111', 'Y', 'N', 'Form / HRD / 017-Rev.00', 'Y', 1, '2021-03-23'),
(11, '2072', 2021, 11, 0, 11, '2021-04-03', '2021-04-13', '111', 'Y', 'Y', 'Form / HRD / 017-Rev.00', 'Y', 1, '2021-03-23'),
(12, '2072', 2021, 0, 0, 0, '2021-03-23', '2021-03-23', 'alasan cuti', 'Y', 'N', 'Form / HRD / 017-Rev.00', 'Y', 1, '2021-03-23'),
(13, '2072', 2021, 0, 0, 0, '2021-03-23', '2021-03-23', 'alasan cuti', 'Y', 'Y', 'Form / HRD / 017-Rev.00', 'Y', 1, '2021-03-23');
...
(4, '2001', 2021, 1, 20000, NULL, 0, 'Y', 1, '2021-03-23'),
(5, '2004', 2021, 1, 0, 0, 100000, 'Y', 1, '2021-03-23'),
(6, '2004', 0, 0, NULL, NULL, 12000, 'Y', 1, '2021-03-23'),
(7, '2003', 0, 0, NULL, NULL, 123, 'Y', 1, '2021-03-23'),
(8, '2006', 2021, 1, 250000, NULL, 1000000, 'Y', 1, '2021-03-23'),
(9, '2003', 2021, 1, 2000, 20000, 0, 'Y', 1, '2021-03-23'),
(10, '2007', 2021, 1, NULL, 0, 11234, 'Y', 1, '2021-03-23'),
(11, '2034', 2021, 1, NULL, NULL, 100000, 'Y', 1, '2021-03-23'),
(12, '2011', 2021, 1, NULL, NULL, 0, 'Y', 1, '2021-03-23'),
(13, '2072', 2021, 3, 0, NULL, NULL, 'Y', 1, '2021-03-23');
...
(4, '2072', 2021, 3, 328125, 'utang perusahaan', 'Y', 1, '2021-03-23'),
(5, '2072', 2021, 2, 328125, 'utang perusahaan', 'Y', 1, '2021-03-24');
...
(2, '2031', '2021-01-03', 'Alasan Izin...', 'Jam Datang', '12:30:00', 'Form/HRD/018-Rev.01', 'Y', 1, '2021-03-23'),
...
(14, '2017', '2021-01-04', 'alasan datang', 'Jam Datang', '10:40:00', 'Form/HRD/018-Rev.01', 'Y', 1, '2021-03-23');
...
--
ALTER TABLE `transaksi_surat_ijin`
  MODIFY `id_surat_ijin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
